      ...
      <div className={style.aboutSection}>
        ...
        <div className={style.bodyContainer}>
          ...
          <Typography variant="body2" className={style.bodyText}>
            ...
            user-centric, visually stunning web applications. Proficient in JavaScript, 
            React.js, Next.js, and SASS, with expertise in Tailwind CSS for modern, 
            responsive designs. Skilled in UI/UX design using Figma, Penpot and professional 
            graphics design with Photoshop. Experienced in cross-platform mobile 
            development with React Native, and expanding backend knowledge 
            with Java and Spring Boot framework.

            A two-time hackathon winner holding a bachelor's degree in computer science, I thrive under pressure and excel in 
            collaborative environments, driving innovation in fast-paced teams. 
            Passionate about self-improvement, leadership, and mentoring, with a deep 
            appreciation for self-development books and a genuine love for inspiring 
            young minds. Excited to contribute my expertise to groundbreaking projects.
          </Typography>
      ...
      <div className={style.expertContainer}>
        ...
        <div className={style.expertCards}>
          <div className={style.cardOne}>
            ...
            <span>2022</span>
            <BiSolidRightArrow size={57} color={"#12182b"} className="ml-[-0.8rem]" />
            </div>
